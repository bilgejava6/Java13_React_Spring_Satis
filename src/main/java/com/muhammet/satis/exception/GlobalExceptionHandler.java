...
import static com.muhammet.satis.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> authServiceHandler(SatisServiceException authServiceException){
